...
#    if request.user.is_authenticated:
#        return HttpResponseRedirect('afterlogin')
#    return render(request,'hospital/admin_view_medicine.html')
...
# Admin view Medicine View
# @login_required(login_url='adminlogin')
# @user_passes_test(is_admin)
# def admin_view_medicine_view(request):
#    doctors=models.Doctor.objects.all().filter(status=True)
#    return render(request,'hospital/admin_view_medicine.html',{'drugs_stock':doctors})
...
def medicine_view(request):
    ...
    mydict = {'userForm': userForm, 'medicineForm': medicineForm}
    if request.method == 'POST':
        ...
        if medicineForm.is_valid():
            ...
            user.save()
            return HttpResponseRedirect('admin-view-doctor')
        return render(request, 'hospital/admin_view_medicine.html', context=mydict)
...
def admin_view_medicine_view(request):
    ...
    return render(request, 'hospital/admin_view_medicine.html', {'medicine': medicine})
